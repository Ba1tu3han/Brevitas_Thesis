...
export_path = f"QONNX_Tensil_{model_name}_{weight_bit_width}W{act_bit_width}A.onnx"
#export_qonnx(model, input_tensor, export_path=export_path)
torch.onnx.export(model, input_tensor, export_path,opset_version=10) # normal ONNX export for Tensil
