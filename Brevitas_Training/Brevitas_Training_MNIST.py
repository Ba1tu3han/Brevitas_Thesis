...
torch.backends.cudnn.deterministic = True #for reproducibility, True for not changing
torch.backends.cudnn.benchmark = False #for reproducibility, False for not changing
...
test_dataloader = DataLoader(test_data, batch_size=batch_size,
                             sampler=torch.utils.data.RandomSampler(test_data, num_samples=n_sample),shuffle=False)
